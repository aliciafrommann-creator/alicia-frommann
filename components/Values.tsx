...
const VALS = [
  { num: 'i.',   word: 'Freedom', blue: false, italic: false, text: 'Not the cheap kind — the kind that costs you something. The right of every person to author their own life inside the constraints they did not choose. Most of my work is making the constraints visible, so what is left can actually be chosen.' },
...
export default function Values() {
  ...
  return (
    <section ref={ref} id="values" style={{ borderTop: '1px solid var(--line)' }}>
      <span className="tag" style={{ display: 'block', padding: 'clamp(60px,8vw,100px) var(--pad-x) 0' }}>§ 08 — Three points of the compass</span>
      {VALS.map((v, i) => (
