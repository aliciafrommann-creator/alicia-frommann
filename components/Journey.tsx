    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <p style={{fontFamily:'var(--font-geist)',fontSize:'clamp(16px,1.3vw,20px)',fontWeight:400,lineHeight:1.45,color:'var(--ink)',letterSpacing:'-.01em'}}>
            Next chapter:<br/>
            <em style={{color:'var(--blue)',fontStyle:'italic'}}>Berlin. Building in public.</em>
          </p>
          <p style={{fontFamily:'var(--font-geist-mono)',fontSize:'11px',color:'var(--ink-4)',letterSpacing:'.04em',lineHeight:1.6}}>
            Summer 2026 · Gründerszene Startup-Sommercamp
          </p>
        </div>
      </div>
